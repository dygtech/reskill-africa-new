      ...
      <div className="max-w-[1200px] mx-auto px-8 md:px-12 flex flex-col lg:flex-row gap-16 lg:gap-24 relative">
        ...
        <div className="w-full lg:w-[45%] lg:sticky top-[30vh] h-fit">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-brand-light-2 mb-8">
            ...
            <span className="text-[13px] font-medium text-brand-dark">The Full Loop</span>
          </div>

          {/* Bank Vault Number Spin Title */}
          <div className="h-[60px] md:h-[80px] overflow-visible relative" style={{ perspective: 1000 }}>
            <p className="text-brand-gray text-[17px] leading-[1.6] max-w-100 font-light mb-2">
            ...
            >
              ...
              <div className="px-2">
                <h3 className="text-[20px] text-brand-dark mb-4 flex items-center gap-3">
                  <span className={`font-bold transition-colors duration-500 ${activeIndex >= index ? 'text-primary' : 'brand-gray-300'}`}>
                    0{index + 1}
                  </span>
                ...
                <p className="text-brand-gray text-[15px] leading-[1.7] font-light">
                  <span className="capitalize font-medium text-brand-dark">{pillar.desc.split(" ")[0]}</span> {pillar.desc.substring(pillar.desc.indexOf(" ") + 1)}
                </p>
              </div>
            </motion.div>
          ))}
