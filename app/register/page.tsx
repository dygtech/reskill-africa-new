    ...
    <main className="h-screen w-full flex flex-col lg:flex-row bg-[#2a2422] font-sans overflow-hidden">
      ...
      <div className="hidden lg:flex flex-col w-[60%] text-white p-12 relative h-full">
        ...
        <p className="text-[#a09a98] text-[15px] font-light">
          Join ReSkill Africa and start your learning journey
        </p>
        ...
        {/* Bottom Illustration */}
        <div className="absolute bottom-16 left-1/2 -translate-x-1/2 w-full flex justify-center z-0 opacity-80">
          <Image
            ...
            height={300}
            priority
            className="w-auto h-auto object-contain drop-shadow-2xl rounded-2xl"
          />
        </div>
      </div>
      ...
      <div className="w-full lg:w-[40%] flex flex-col h-screen bg-white lg:rounded-l-[48px] shadow-2xl z-10 relative">
        ...
        <div className="flex-1 flex flex-col px-8 sm:px-12 overflow-y-auto">
          <div className="w-full max-w-90 mx-auto my-auto py-2">
            <h2 className="text-[44px] font-medium text-[#111] mb-6 tracking-tight">Sign Up</h2>

            <form className="flex flex-col gap-3">

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="flex flex-col gap-1">
                  <label className="text-[12px] font-semibold text-brand-dark uppercase tracking-wide">First Name</label>
                  <input
                    type="text"
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-[12px] font-semibold text-brand-dark uppercase tracking-wide">Last Name</label>
                  <input
                    type="text"
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-[14px] text-black"
                  />
              ...
              <div className="flex flex-col gap-1">
                <label className="text-[12px] font-semibold text-brand-dark uppercase tracking-wide">Email</label>
                <input
                  type="email"
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-[14px] text-black"
                />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="flex flex-col gap-1">
                  <label className="text-[12px] font-semibold text-brand-dark uppercase tracking-wide">Phone Number</label>
                  <input
                    type="tel"
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-[14px] text-black"
                  />
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-[12px] font-semibold text-brand-dark uppercase tracking-wide">Country</label>
                  <select
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-[14px] text-black appearance-none"
                    defaultValue=""
                  >
              ...
              <div className="flex flex-col gap-1">
                <label className="text-[12px] font-semibold text-brand-dark uppercase tracking-wide">Password</label>
                <input
                  type="password"
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-[14px] text-black"
                />
